...
Color blend(const Color& fg, const Color& bg) {
    Uint32 out_a = fg.a + bg.a * (256 - fg.a) / 256;
    if (out_a == 0) {
        return {0, 0, 0, 0};
    }
    Uint32 out_r = (fg.r * fg.a + bg.r * bg.a * (255 - fg.a) / 256) / out_a;
    Uint32 out_g = (fg.g * fg.a + bg.g * bg.a * (255 - fg.a) / 256) / out_a;
    Uint32 out_b = (fg.b * fg.a + bg.b * bg.a * (255 - fg.a) / 256) / out_a;
